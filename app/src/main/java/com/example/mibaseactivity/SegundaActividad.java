...
public class SegundaActividad extends MiBaseActivity {
        ...
        builder.setNeutralButton("Google Map", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (mapIntent.resolveActivity(getPackageManager()) != null)
                    ...
                    Toast.makeText(SegundaActividad.this, "Maps no esta instalado", Toast.LENGTH_LONG).show();
            }
        });
        builder.setNegativeButton("Waze", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (mapIntent.resolveActivity(getPackageManager()) != null)
                    ...
                    Toast.makeText(SegundaActividad.this, "Waze no esta instalado", Toast.LENGTH_LONG).show();
            }
        });
